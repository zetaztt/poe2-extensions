 ...
 */
export const ipcMain = new IpcChannel(ipcMainRegistrationKey, createMainWorldIpcMain);
/**
 * MAIN world 持有页面能力，是 ipcWindow 的唯一 RPC 服务端。
 */
export const ipcWindow = new IpcHandlerChannel(ipcWindowRegistrationKey, createMainWorldIpcWindow);
